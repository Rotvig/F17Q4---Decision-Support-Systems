...
\begin{document}
    ...
    \include{chapter/linear_regression}
    \include{chapter/logistic_regression}
    \include{chapter/linear_descreminant_analysis}
    \include{chapter/cross_validation}
    \include{chapter/bootstrap}
    \include{chapter/subset_selection}
    \include{chapter/unsupervised_learning}
    \include{chapter/clustering}
