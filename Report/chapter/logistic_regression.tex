...
\todo{Hvorfor er det i en centering?}
\begin{centering}
...
\todo{Hører det til her? er lidt i tvivl om det skal med her eller stå i lab}
...
\todo{..this might lead to a better result using \emph{Lag1} and \emph{Lag2} for prediction instead of \emph{Lag1} and \emph{Lag2}.. Det for står jeg ikke helt. }
...
\todo{Der står ikke noget om dette. Burde vi ikke have noget om det?}
