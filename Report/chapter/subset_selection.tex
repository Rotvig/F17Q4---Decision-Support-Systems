...
In this exercise a best subset selection is performed on a dataset called Hitters. The dataset is used for predicting the salary of baseball players. Before performing best subset selection the data is split into predictors and the response variable.
...
\begin{table}	
	...
	\end{subtable}
	\caption{Calculated mean squared error from 6 to 13 predictors.}\label{table:mse}
\end{table}
