...
The code in Listing \ref{lst:lin_reg_plot} is used to plot the Linear Regression. To plot, the python libary \emph{matplotlib} is used. In line 1 the test data is plotted to see how it corresponds to the linear function. To plot the linear function the command 'plot' is used this is seen in line 2. Where 'boston\_X\_test' is the test data which consist of the \emph{lstat} data. 
