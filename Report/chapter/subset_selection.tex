...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\EndFor
		\State Choose a single best models from all the best models in $M_0,...M_k$. The best model is chosen based on $C_p$, $BIC$ or adjusted $R^2$ if the whole data set is used for choosing the best subset.
	\end{algorithmic}
\end{algorithm}
