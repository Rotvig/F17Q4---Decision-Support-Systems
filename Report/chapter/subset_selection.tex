...
TThis gave some results.. \todo{Add results when computation is done...}
...
The results gives a mean squared error for each number of predictors. This is shown somewhere.. \todo{indsæt noget resultat}