...
\myFigure{validationSetApproach_poly.png}{Validation error estimates for a single split}{fig:poly_valid}{0.6} \todo{Needs to be removed if we can't use figures from the book}
...
\myFigure{K_fold_result.png}{Result of K-fold Cross-validation}{fig:result_K_fold}{0.3}
